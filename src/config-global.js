...
// export const HOST_API = 'https://api.return2success.com';
export const HOST_API = 'http://localhost:3001';
// export const HOST_API = 'http://192.168.29.19:8080';

export const ASSETS_API = import.meta.env.VITE_ASSETS_API;

export const RAZORPAY_API_KEY = 'rzp_live_L9zPJEPZ8aQNSL';
...
export const PATH_AFTER_LOGIN = paths.findBusiness; // as '/dashboard'
